...
public class RulesConstant {
    ...
    public static final Double START_INTEREST_RATE = 5.0;
    public static final String DISQUALIFIED_STATE = "florida";
    ...
    public static final String INCREASED_RATE_PRODUCT_NAME = "7-1 ARM";
