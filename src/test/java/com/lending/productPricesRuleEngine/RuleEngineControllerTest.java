package com.lending.productPricesRuleEngine;

import com.lending.productPricesRuleEngine.model.*;
import com.lending.productPricesRuleEngine.service.RulesEngine;
import com.lending.productPricesRuleEngine.model.*;
import com.lending.productPricesRuleEngine.service.RulesLoader;
...
import static com.lending.productPricesRuleEngine.service.RulesLoader.RULE_SERVICE_URL;
...
public class RuleEngineControllerTest {
    ...
    public void send_request_should_return_decrease_rate_when_credit_score_greater_or_equal_720()
    {
        ...
        rulesDefinition.setAction(RulesConstant.DECREASE_RATE);
        ...
        actionTriggerCreditScore.setPersonCreditSCoreComparisonOperator(RulesConstant.GREATER_THAN_OR_EQUAL_TO);
    ...
    public void send_request_should_return_increase_rate_when_credit_score_less_Than_720()
    {
        ...
        RulesDefinition rulesDefinition = new RulesDefinition();
        rulesDefinition.setAction(RulesConstant.INCREASE_RATE);
        ...
        ActionTrigger actionTriggerCreditScore = new ActionTrigger();
        actionTriggerCreditScore.setPersonCreditSCore("720");
        actionTriggerCreditScore.setPersonCreditSCoreComparisonOperator(RulesConstant.LESS_THAN);
    ...
    public void send_request_should_return_disqualify_when_person_State_is_florida()
    {
        ...
        RulesDefinition rulesDefinition = new RulesDefinition();
        rulesDefinition.setAction(RulesConstant.DISQUALIFY);
    ...
    public void send_request_should_return_decrease_rate_of_5_percent_when_credit_score_greater_or_equal_750_with_many_rules()
    {
        ...
        rulesDefinitionDisqualify.setAction(RulesConstant.DISQUALIFY);
        ...
        rulesDefinitionIncreaseRate.setAction(RulesConstant.INCREASE_RATE);
        ...
        actionTriggerIncreaseDisqualify.setPersonCreditSCoreComparisonOperator(RulesConstant.LESS_THAN);
